...
# Use jq to extract the required data
...
# The Header (You could use https://fsymbols.com/ or http://patorjk.com/software/taag/ to generate ASCII signs)
echo -e "${GREEN}"
echo "------------------------------"
